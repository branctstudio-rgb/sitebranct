...
const trustClasses = {
  ...
  executors: ["scripts/governance/classify-pr-paths.mjs", "scripts/governance/f2-gov-08-consumer.mjs", "scripts/governance/f2-gov-08-static-server.mjs", "scripts/governance/validate-f2-gov-08.mjs", "scripts/governance/verify-f2-01-readiness.mjs", "scripts/deploy/build-publish-payload.mjs"],
  tests: ["tests/audit/f2-gov-02a.test.mjs", "tests/audit/f2-gov-02c.test.mjs", "tests/audit/f2-gov-08.test.mjs", "tests/audit/phase-2-governance.test.mjs", "tests/audit/f2-gov-01.test.mjs", "tests/deploy/deploy-scope.test.mjs", "tests/audit/site-audit.test.mjs", "tests/audit/f2-01-responsive.test.mjs"],
  browserVisual: ["tests/audit/collect-browser-baseline.mjs", "tests/audit/check-visual-evidence.mjs"],
  authorities: ["deploy/publish-manifest.json", "fixtures/audit/site-contract.json", "fixtures/audit/baseline-results.json", "fixtures/audit/evidence-manifest.json", "fixtures/audit/f2-gov-08-authority-manifest.json", "fixtures/audit/f2-gov-08-base-only-contract.json", "fixtures/audit/f2-gov-08-expectations.json", "fixtures/audit/f2-gov-08-matrix.json", "fixtures/audit/f2-01-ci-runtime.json", "fixtures/audit/f2-01-transition.json", "fixtures/audit/f2-01-baseline-results.json", "fixtures/audit/f2-01-menu-evidence-matrix.json", "package.json", "package-lock.json", "docs/audit/phase-2/f2-00-contract.json"],
};
...
test("sentinel protects the complete F2-GOV-09 base-only measurement authority", async () => {
  const protectedPaths = protectedGatePaths(await read(sentinelPath));
  for (const path of [
  ...
  ]) assert.ok(protectedPaths.includes(path), `F2-GOV-09 trust path missing: ${path}`);
});
